...
public class FeedFragment extends Fragment {
    ...
    private void buildRecyclerView() {
        ...
        postList.add(new postData("Ashwin","Amazon","24-11-2021","13:02","Hello 1",AMAZON_LOGO,true));
        postList.add(new postData("Aagam","Cisco","25-11-2021","13:02","Hello 2",CISCO_LOGO,true));
        postList.add(new postData("Harsh","GE","26-11-2021","13:02","Hello 3","",false));
